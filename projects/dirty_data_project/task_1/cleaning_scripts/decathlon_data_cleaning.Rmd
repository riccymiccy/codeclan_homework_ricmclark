...
### Let's now lengthen the data using the pivot_longer function and create two new variable names: events and performance. This last part is critical to make the data easier to analyse.
<details>
...
<br>
### Finally let's change all athletes names to lower case
